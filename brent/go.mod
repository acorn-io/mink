module github.com/acorn-io/mink/brent

go 1.21.5

require (
	github.com/acorn-io/brent v0.0.0-20240111054103-1decca8a54d3
...
require (
	...
	github.com/acorn-io/baaah v0.0.0-20240111044744-384c1595d964 // indirect
